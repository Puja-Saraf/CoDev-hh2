...
export default function CreateProfile() {
  ...
  return (
    <div className="onboarding bg-[#FFD9C0] bg-opacity-20">
      <h2 className='text-2xl md:text-3xl font-bold text-[#fd2f6e] text-center pt-8 pb-5'>Create Profile</h2>

      <form className='justify-center w-[50%] ml-[25%] md:w-[36%] md:ml-[32%]' onSubmit={handleSubmit}>
        <section className='flex flex-col'>
          <label htmlFor="full_name" className='mt-2.5 text-start'>Full Name</label>
          <input
          ...
          <label htmlFor="years_exp" className='mt-2.5 text-start'>Years of Experience</label>
          <input
