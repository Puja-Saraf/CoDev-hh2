  ...
  return (
    <div className=' ml-6 mr-6 md:ml-10 md:mr-10 lg:ml-24 lg:mr-24 xl:ml-32 xl:mr-32 mt-28'>
      ...
      <div className='mt-11 flex flex-row justify-center items-center mb-14'>
        <button className='bg-[#fe5740] pt-2 pb-2 pl-4 pr-4 text-white text-lg rounded-full mr-6' onClick={handleReject}>Pass</button>
        <button className='bg-[#fd2f6e] pt-2 pb-2 pl-4 pr-4 text-white text-lg rounded-full' onClick={handleMatch}>Collaborate</button>
      </div>
    </div>
  )
}
