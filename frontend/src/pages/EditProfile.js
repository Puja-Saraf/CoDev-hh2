...
export default function EditProfile({user}) {
  ...
  return (
    <div className="onboarding bg-[#FFD9C0] bg-opacity-20">
      <h2 className='text-2xl md:text-3xl font-bold text-[#fd2f6e] text-center pt-8 pb-5'>Edit Profile</h2>

      <form className='justify-center w-[50%] ml-[25%] md:w-[36%] md:ml-[32%]' onSubmit={handleSubmit}>
        <section className='flex flex-col'>
          <label htmlFor="name" className='mt-2.5 text-start'>Full Name</label>
          <input
          ...
          <label htmlFor="professional_title" className='mt-2.5 text-start'>Professional Title</label>
          <input
          ...
          <label htmlFor="years_of_experience" className='mt-2.5 text-start'>Years of Experience</label>
          <input
          ...
          <label htmlFor="github_username" className='mt-2.5 text-start'>Github Username</label>
          <input
          ...
          <label htmlFor="show-dob" className='mt-7 text-start check-cont'>Show DOB on my Profile
            <input
              className=''
              id="show-dob"
              type="checkbox"
          ...
          <div className="multiple-input-container flex flex-row">
            ...
            />
            <label htmlFor="man-gender-identity" className='mt-2.5 mb-2.5 p-2.5 border-gray-400 border-2 rounded-lg mr-2.5 transition-all duration-300 cursor-pointer'>Man</label>
            <input
              className='hidden p-2 md:p-3 mt-2.5 mb-2.5 mr-2 text-base border-[#2f2e41] border-2 rounded-lg'
            ...
            />
            <label htmlFor="woman-gender-identity" className='mt-2.5 mb-2.5 p-2.5 border-gray-400 border-2 rounded-lg mr-2.5 transition-all duration-300 cursor-pointer'>Woman</label>
            <input
              className='hidden p-2 md:p-3 mt-2.5 mb-2.5 mr-2 text-base border-[#2f2e41] border-2 rounded-lg'
            ...
            />
            <label htmlFor="more-gender-identity" className='mt-2.5 mb-2.5 p-2.5 border-gray-400 border-2 rounded-lg mr-2.5 transition-all duration-300 cursor-pointer'>Other</label>
          </div>

          <label htmlFor="show-gender" className='mt-7 text-start check-cont'>Show Gender on my Profile
            <input
              className=''
              id="show-gender"
              type="checkbox"
          ...
          <label htmlFor="show-email" className='mt-5 text-start check-cont'>Show Email on my Profile
            <input
              className=''
              id="show-email"
              type="checkbox"
          ...
          <label htmlFor="skills" className='mt-8 text-start'>Skills</label>
          <Multiselect
            displayValue="key"
            className='dropdown'
            groupBy="cat"
          ...
          <label htmlFor="about" className='mt-2.5 text-start'>About me</label>
          <input
            className='w-[100%] p-2 md:p-3 mt-2.5 mb-2.5 text-base border-[#2f2e41] border-2 rounded-lg'
            id="about"
            type="text"
          ...
          <label htmlFor="img_url" className=' mt-4 mb-2.5 text-start'>Profile Photo</label>
          ...
          <div className="photo-container w-[100%] mt-2.5 mb-2.5">
            {formData.img_url && <img src={formData.img_url} alt="profile pic preview" />}
          </div>
        </section>

        <button className='text-white bg-gradient-to-r from-[#fd2f6e] to-[#fe5740] px-4 py-2 md:px-6 md:py-3 m-2 rounded-full font-semibold w-fit text-lg md:text-xl cursor-pointer hover:from-[#FFD9C0] hover:to-[#FFD9C0] hover:text-[#fe5740]'>Submit</button>
